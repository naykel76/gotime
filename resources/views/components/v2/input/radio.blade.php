@props(['for' => null, 'controlOnly' => false, 'options' => [], 'value' => null, 'label' => null, 'rowClass' => null, 'tooltip' => false, 'helpText' => null, 'helpTextTop' => false])

{{-- @aware([ 'inline' => false ]) --}}

@if ($controlOnly)
    <x-gotime::v2.input.control-radio {{ $attributes->except(['label', 'help-text', 'rowClass']) }} />
@else
